...
namespace ZooMag.Migrations
{
    ...
    [Migration("20210828053959_editPetModel2")]
    partial class editPetModel2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZooMag.Entities.CategoryFilter", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZooMag.Entities.Filter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ZooMag.Entities.FilterCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ZooMag.Entities.ProductSpecificFilter", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("integer");

                    b.Property<int>("SpecificFilterId")
                        .HasColumnType("integer");

                    b.HasKey("ProductId", "SpecificFilterId");

                    b.HasIndex("SpecificFilterId");

                    b.ToTable("ProductSpecificFilters");
                });
            ...
            modelBuilder.Entity("ZooMag.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "f0fa74f1-e994-4b14-9804-de2d30ea3661",
                            Name = "Администратор",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "2b3c1436-a409-487c-a153-aa527e3900f5",
                            Name = "Бухгалтер",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "ced6360a-9482-424d-b329-7c66ca7f9223",
                            Name = "Клиент",
            ...
            modelBuilder.Entity("ZooMag.Entities.SpecificFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ZooMag.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9a1c7176-d425-475e-a4e4-e0ce3e6840eb",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEJy80krYiGsi+kJSGE/CeBhGsaoOa3fgRG5LvsHWADYFr410RPpFEv9QXTdjxtyllw==",
            ...
            modelBuilder.Entity("ZooMag.Entities.CategoryFilter", b =>
                {
                    ...
                    b.HasOne("ZooMag.Entities.Filter", "Filter")
                        .WithMany("CategoryFilters")
            ...
            modelBuilder.Entity("ZooMag.Entities.Filter", b =>
                {
                    b.HasOne("ZooMag.Entities.FilterCategory", "FilterCategory")
                        .WithMany("Filters")
            ...
            modelBuilder.Entity("ZooMag.Entities.ProductSpecificFilter", b =>
                {
                    b.HasOne("ZooMag.Entities.Product", "Product")
                        .WithMany("ProductSpecificFilters")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ZooMag.Entities.SpecificFilter", "SpecificFilter")
                        .WithMany("ProductSpecificFilters")
                        .HasForeignKey("SpecificFilterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Product");

                    b.Navigation("SpecificFilter");
                });
            ...
            modelBuilder.Entity("ZooMag.Entities.Product", b =>
                {
                    ...
                    b.Navigation("ProductSpecificFilters");
                });
